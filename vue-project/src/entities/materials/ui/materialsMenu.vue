<template>
    <div id="MainContainerMenu" v-if="store.selectedDisciplineId != 'cons'">
        ...
        <labCard class="labCart" v-for="lab in LabsByDisciplineId" @selectTheoryId="handleSelectTheoryId" :id="lab.id" :key="lab.id"></labCard>
        ...
        <materialCard class="labCart" v-for="lab in Materials" :idTheory="lab.id" :id="'theory' + lab.id" :key="lab.id"></materialCard>
...
const LabsByDisciplineId = computed(() => materialsStore.getLabsByDisciplineId(store.selectedDisciplineId))


const Materials = computed(() => materialsStore.getTheoryByDisciplineId(store.selectedDisciplineId))
